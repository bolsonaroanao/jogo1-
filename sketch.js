...
class Bullet {
  ...
  draw() {
    strokeWeight(2);
    stroke(red(0, 256), blue(0, 256), red(0, 256));  
    fill(red(0, 256), red(0, 256), red(0, 256),(0, 256)); 
...
class Player {
  ...
  draw() {
    ...
    triangle(this.posX+15, this.posY-2    , this.size/2);
    fill("white");
    circle(this.posX, this.posY, this.posX+30, this.posY, this.posX+15, this.posY-20);
